            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="addEmp.php"><i class="fa fa-bar-chart-o fa-fw"></i> Dar de elta empleado<span class="fa arrow"></span></a>
                                    ...
                                    <label>Fecha de nacimiento: </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="placeEmp">
                                                <option>Elijir un estado de la republica mexicana</option>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="postalEmp" placeholder="Enter code postal">
                                            
                                        </div>
                                        <label style="margin-left: 75px;">Calle /#: </label>
                                        <div class="form-group">
                            ...
                            <div class="row separetorTopInput">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <label style="margin-left: 118px;">Teléfono: </label>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="socialEmp">
                                                <option>¿Cuenta con seguro social?</option>
                                                <option>Si</option>
                                                <option>No</option>
                                            </select>
                             ...
                             <div class="row separetorTopInput">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="numSocial" placeholder="Enter social security">
                                            
                                        </div>
                                        <label style="margin-left: 27px;">Cuenta bancaria: </label>
                                        <div class="form-group">
                                            
                                            
                                            <input type="text" class="form-control" name="bankEmp" placeholder="Enter bank count">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <label style="margin-left: 207px;">Servicio: </label>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <label style="margin-left: 68px;">Bloqueado: </label>
                                        <div class="form-group">
                                            
                                            
                                            <select class="form-control" name="lockedEmp"> 
                                                <option>¿El empleado esta bloqueado?</option>
                                                <option>Si</option>
                                                <option>No</option>
