        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    ...
                    ?> 
                    <div class="col-lg-12">
                        <h1 class="page-header">Calculo por empleado</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                
                <!-- /.row -->
                <form role="form" action="getEmpService.php" method="post" class="form-inline">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row separetorTopInput">
                                        <!-- /.col-lg-6 (nested) -->
                                        <div class="col-lg-12">
                                            <label style="margin-left: 120px;">Quincena: </label>
                                            <div class="form-group">
